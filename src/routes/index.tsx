...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Carpet roll ends, remnants, offcuts and end of line carpets at clearance prices. 4m & 5m widths, up to 70% off, new stock weekly. Delivery across the north of England." },
      { property: "og:title", content: `Mega Value Carpet Roll End Outlet - ${SITE.name}` },
      { property: "og:description", content: "Cheap carpet roll ends, remnants and end of line carpets at clearance prices. First come, first served. Delivery across the north of England." },
      ...
      <section className="relative overflow-hidden text-white border-y-4 md:border-y-[10px] border-pop">
        ...
        <div className="relative container-page py-3 md:py-14 text-center flex flex-col items-center">
          ...
          <p className="mt-2 z-10 text-white/90 font-black text-[0.65rem] sm:text-sm md:text-base uppercase tracking-tight text-balance">
            DELIVERY ACROSS:&nbsp; &nbsp; &nbsp; &nbsp;MANCHESTER{" "}<span className="text-pop">•</span>{" "}LIVERPOOL{" "}<span className="text-pop">•</span>{" "}BRADFORD{" "}<span className="text-pop">•</span>{" "}LEEDS{" "}<span className="text-pop">•</span>{" "}SHEFFIELD{" "}<span className="text-pop">•</span>{" "}YORK{" "}<span className="text-pop">•</span>{" "}HULL
          </p>
